    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                {{ html()->form()->route('admin.prices.store')->open() }}
                <div class="row gy-4">
                                ...
                                <div class="item app-card-settings border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->select('service_id',$services->pluck('name','id'))->required()->attributes(['id'=>'services','class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item app-card-settings border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->select('room_type_id',$roomTypes->pluck('name','id'))->required() ->attributes(['id'=>'services','class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->number('room_quantity')->required()->attributes(['id'=>'room_quantity','step'=>'0.5','class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->text('price_for_next_unit')->required()->attributes(['id'=>'price_for_next_unit','class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
