                        ...
                        <div class="col-12 col-sm-6 col-lg-4 col-md-4 col-xl-4 col-xxl-3">
                            <div class="app-card app-card-doc shadow-sm h-100">
                                ...
                                <div class="app-card-body p-3 has-card-actions">
                                    ...
                                    <h4 class="app-doc-title truncate mb-0"><a href="{{ route('admin.services.edit',$item) }}">{{ $item->name }}</a></h4>
                                    <div class="app-doc-meta">
                                        <ul class="list-unstyled mb-0">
                                            <li><span class="text-muted">Створено:</span> {{ $item->created_at->format('F d Y h:i:s A') }}</li>
                                            <li><span class="text-muted">Змінено:</span> {{ $item->created_at->format('F d Y h:i:s A') }}</li>
                                            {{--
                                    ...
                                    <div class="app-card-actions">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdown-menu-{{ $item->id }}">
                                                <li>
                                                    <a class="dropdown-item" target="_blank" href="{{ route('services.show',$item->slug) }}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('admin.services.edit',$item) }}">
                                                ...
                                                <li>
                                                    {{ html()->form('put')->route('admin.services.destroy', $item->slug)->acceptsFiles()->open() }}
                                                    @csrf
                                                    @method('DELETE')
