    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                {{ html()->form()->route('admin.additional-services.store')->acceptsFiles()->open() }}
                <div class="row gy-4">
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->textarea('base64image')->attributes(['id'=>'base64image','class'=>'form-control textarea','cols'=>'100','rows'=>'30','style'=>'height:300px;']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
