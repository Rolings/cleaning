    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                {{ html()->form('put')->route('admin.reviews.update',$item)->acceptsFiles()->open() }}
                <div class="row gy-4">
                                    ...
                                    <div class="app-card-body">
                                        ...
                                        <div class="mb-3 row justify-content-between align-items-center">
                                            <div class="col-12">
                                                ...
                                                <div class="item-data">
                                                    <img class="profile-image" width="300" src="{{ is_null($item->image) ? $no_image : $item->image->url}}" id="image" alt="">
                                                </div>
                                            </div><!--//col-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <div class="col-6">
                                            ...
                                            {{ html()->number('rating',$item->rating)->required()->attributes(['id'=>'rating','min'=>1,'max'=>5, 'class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->textarea('comment',$item->comment)->required()->attributes(['id'=>'comment','class'=>'form-control textarea textarea-editor','cols'=>'100','rows'=>'30','style'=>'height:300px;']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
