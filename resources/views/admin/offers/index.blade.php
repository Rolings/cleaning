        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">
                        <h1 class="app-page-title mb-0">Пропозиції</h1>
                    </div>
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="{{ route('admin.offers.create') }}">
                                        Додати пропозицію
                                    </a>
                                </div>
                            </div><!--//row-->
                            ...
                            <table class="table app-table-hover mb-0 text-left">
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td class="cell"><a class="btn-sm app-btn-secondary" href="{{ route('admin.offers.edit',$item) }}">Редагувати</a></td>
                                        <td class="cell">
                                            {{ html()->form('delete')->route('admin.offers.destroy', $item)->open() }}
                                            @csrf
                                            @method('DELETE')
