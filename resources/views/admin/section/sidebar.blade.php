        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link @if(request()->route()->named('admin.dashboard.index')) active @endif" href="{{ route('admin.dashboard.index')  }}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.callbacks.index','admin.callbacks.index.new','admin.callbacks.index.read', 'admin.callbacks.edit', 'admin.callbacks.create'])) active @endif" href="{{ route('admin.callbacks.index')  }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Запити клієнтів</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->

                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.orders.index','admin.orders.index.new','admin.orders.index.read', 'admin.orders.edit', 'admin.orders.create'])) active @endif" href="{{ route('admin.orders.index')  }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Замовлення</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                <li class="sidebar-border-line"></li>
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.offers.index', 'admin.offers.edit','admin.offers.create'])) active @endif" href="{{ route('admin.offers.index')  }}">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                              <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2zm3.564 1.426L5.596 5 8 5.961 14.154 3.5zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464z"/>
                            </svg>
                         </span>
                        <span class="nav-link-text">Пропозиції</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link @if(request()->route()->named(['admin.room-types.index', 'admin.room-types.edit','admin.room-types.create'])) active @endif" href="{{ route('admin.room-types.index')  }}">
                        ...
                        <span class="nav-link-text">Типи кімнат</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.projects.index', 'admin.projects.edit', 'admin.projects.create'])) active @endif" href="{{ route('admin.projects.index')  }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Проекти</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->

                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.history.index', 'admin.history.edit', 'admin.history.create'])) active @endif" href="{{ route('admin.history.index')  }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Історія</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->

                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.questions.index', 'admin.questions.edit', 'admin.questions.create'])) active @endif" href="{{ route('admin.questions.index')  }}">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Часті питання</span>
                    </a><!--//nav-link-->
                </li><!--//nav-item-->

                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.reviews.index', 'admin.reviews.edit', 'admin.reviews.create'])) active @endif" href="{{ route('admin.reviews.index')  }}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(request()->route()->named(['admin.pages.index', 'admin.pages.edit', 'admin.pages.create'])) active @endif" href="{{ route('admin.pages.index')  }}">
                        <span class="nav-icon">
                ...
                <li class="nav-item has-submenu">
                    <a class="nav-link submenu-toggle @if(!request()->is("*/condition/*")) collapsed @else active @endif" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="{{ request()->is("*/condition/*") }}" aria-controls="submenu-1">
                        <span class="nav-icon">
                        ...
                        <span class="nav-link-text">Умови</span>
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1 @if(request()->is("*/condition/*")) show @endif" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.condition.terms-condition.edit') }}">Умови використання</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.condition.privacy-policy.edit') }}">Політика конфіденційності</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.condition.cookies.edit') }}">Куки</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
                <li class="sidebar-border-line"></li>
        ...
        <div class="app-sidepanel-footer">
            <nav class="app-nav app-nav-footer">
                <ul class="app-menu footer-menu list-unstyled">
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                        <a class="nav-link @if(request()->route()->named(['admin.settings.index', 'admin.settings.show'])) active @endif" href="{{ route('admin.settings.index') }}">
							        <span class="nav-icon">
