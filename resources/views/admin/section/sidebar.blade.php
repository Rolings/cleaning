                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.condition.terms-condition.index') }}">Умови використання</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.condition.privacy-policy.index') }}">Політика конфіденційності</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('admin.condition.cookies.index') }}">Куки</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
                <li class="sidebar-border-line"></li>
