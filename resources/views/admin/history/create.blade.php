    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                {{ html()->form('post')->route('admin.history.store')->acceptsFiles()->open() }}
                <div class="row gy-4">
                        ...
                        <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                            <div class="app-card-body px-4 w-100">
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            <div class="item-label"><strong>Дата відображення</strong></div>
                                            {{ html()->datetime('event_date_at')->required()->attributes(['id'=>'event_date_at','class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                            ...
                            <div class="col-12 p-3">
                                <a class="btn app-btn-secondary float-start"  href="{{ route('admin.history.index') }}">Назад</a>
