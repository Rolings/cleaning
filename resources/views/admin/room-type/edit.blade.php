    ...
    <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                {{ html()->form('put')->route('admin.room-types.update', $item)->open() }}
                <div class="row gy-4">
                        ...
                        <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                            <div class="app-card-body px-4 w-100">
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->number('min',$item->min)->required()->attributes(['id'=>'min','min'=>0.5,'step'=>0.5,'class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-12">
                                            ...
                                            {{ html()->number('max',$item->max)->required()->attributes(['id'=>'max','min'=>0.5,'step'=>0.5,'class'=>'form-control']) }}
                                        </div><!--//col-->
                                    </div><!--//row-->
                                </div><!--//item-->
                                ...
                                <div class="item app-card-settings border-bottom py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-auto">
                                            {{ html()->checkbox('fractional',$item->fractional,1)->attributes(['id'=>'fractional','class'=>'form-check-input']) }}
