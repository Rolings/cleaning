                                    ...
                                    <li class="col-12 col-md-3 mb-3 p-0 m-0">
                                        ...
                                        <span>
                                            ...
                                            <span class="d-inline-block mt-2 custom-tooltip"
                                                  ...
                                                  data-bs-toggle="tooltip"
                                                  data-bs-placement="top">
                                                    <span class="tooltip-text d-none">{!! $service->description !!}</span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                     class="bi bi-question-circle" viewBox="0 0 16 16">
                                                  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                                                  <path
                        ...
                        <div class="card h-100">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        @foreach($this->checkoutService->selectedRooms as $room)
                                            <li class="list-group-item"> - {{ $room->name }}: {{ $this->checkoutService->selectedRoomsCount[$room->id]??0}}</li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="list-group-item">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <span class="text-uppercase">{{ 'Service date: '.$checkoutService->datetime?->format('m/d/Y')??'-' }}</span>
                                </li>
                                <li class="list-group-item">
                                    <span class="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="row">
                    <div class="col-12" wire:ignore>
                        <div class="form-group">
                            ...
                            {{ html()->text('order_at')->required()->placeholder('')->attributes(['id'=>'order_atd','class'=>'form-control date-time-picker','wire:model.live'=>'selectOrderAt']) }}
                        </div>
                    </div>
                </div>
            </div>
